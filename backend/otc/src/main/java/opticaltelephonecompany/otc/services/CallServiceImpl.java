...
import opticaltelephonecompany.otc.exception.DatabaseException;
...
public class CallServiceImpl implements CallService {
    ...
    public CallServiceImpl(CallRepository callsRepository, UserRepository userRepository,
            CallReceiverRepository callReceiverRepository, InvoiceService invoiceService, 
            CurrentCallRepository currentCallRepository, RabbitMQJsonProducer rabbitMQJsonProducer) {
    ...
    public Call makeCall(String username, String telephone, CallDto callsDTO) {
        ...
        try {
           ...
           // DateTimeFormatter formatter = DateTimeFormatter.ofPattern("HH:mm:ss");
            ...
            //LocalDateTime endTime = LocalDateTime.parse(callsDTO.getEndTime(), formatter);
    
            // LocalDateTime setTime = formatter.parseLocalDateTime(callsDTO.getEndTime());
